...
void NEUMINUTE (int LOW_Zeit) {
  if (LOW_Zeit >= 1700) {
    ...
    PAR_BEGINN = ZEIT[20];
    ZEIT_WOCHENTAG = ZEIT[42]*1+ZEIT[43]*2+ZEIT[44];
    ...
    if(ZEIT_WOCHENTAG==1)  Serial.print ("Mo, ");
    if(ZEIT_WOCHENTAG==2)  Serial.print ("Di, ");
    if(ZEIT_WOCHENTAG==3)  Serial.print ("Mi, ");
    if(ZEIT_WOCHENTAG==4)  Serial.print ("Do, ");
    if(ZEIT_WOCHENTAG==5)  Serial.print ("Fr, ");
    if(ZEIT_WOCHENTAG==6)  Serial.print ("Sa, ");
    if(ZEIT_WOCHENTAG==7)  Serial.print ("So, ");
